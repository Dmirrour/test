...
<html>
<head>
    <title>Borrado de permiso</title>
    <style>
        .btn-container {
            display: flex;
...
<div class="div-form"> <!-- Contenedor responsive -> ver codigo css en css/mosficarUsuario.css -->
    <div align="center" class="div-dataUser" style="background-color:#33475b"> <!-- Segundo contenedor responsive -> ver codigo css en css/mosficarUsuario.css -->
        <h2 class="font-weight-bold mb-3" style="color:white"> Borrar Permisos de Circulacion</h2>
        <form action="eliminar-PC" method="post">
            <label for="numero">Número:</label>
            <input type="number" id="delete" name="delete" required><br><br>
            <input type="submit" value="Enviar">
        </form><div class="form-row mb-2">
                <!-- ACA PONE LA DATA -->
                <table>
                    <thead>
                    <tr>
